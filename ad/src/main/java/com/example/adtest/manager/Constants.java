...
public class Constants {
    ...
    public static String MEDIA_ID = "1024";
    ...
    public static final String default_native_posid = "1024018";

    public static final String default_video_posid = "1024020";
    ...
    public static String TT_APPID = "5036888";//穿山甲APPID
    public static String TT_APPNAME = "全民走路_android";//穿上甲APPName
    ...
    public static final String GDT_KEY = "gdt2";//广点通广告对应的key
