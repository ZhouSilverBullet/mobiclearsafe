package com.mobi.step.fragment;
...
import com.mobi.step.WeChatLoginActivity;
import com.mobi.step.app.Const;
import com.mobi.step.app.MyApplication;
import com.mobi.step.base.adapter.CommonAdapter;
import com.mobi.step.base.adapter.RecycleViewHolder;
import com.mobi.step.download.MyDownLoadManager;
import com.mobi.step.eventbean.CheckTabEvent;
import com.mobi.step.eventbean.PleasanEvent;
import com.mobi.step.eventbean.RequestStep;
import com.mobi.step.eventbean.StepEvent;
import com.mobi.step.eventbean.TabTipEvent;
import com.mobi.step.eventbean.UserInfoEvent;
import com.mobi.step.eventbean.ViewpagerEvent;
import com.mobi.step.greendao.TodayStepData;
import com.mobi.step.greendao.TodayStepSessionUtils;
...
import com.mobi.step.main.StepBubble;
...
import com.mobi.step.main.bean.DownLoadBean;
import com.mobi.step.main.bean.RedCoinsBean;
import com.mobi.step.me.activity.MyCardActivity;
import com.mobi.step.me.activity.StepHistoryActivity;
import com.mobi.step.me.activity.WithdrawalActivity;
...
import com.mobi.step.utils.SPUtil;
import com.mobi.step.utils.StatusBarUtil;
import com.mobi.step.utils.ToastUtils;
import com.mobi.step.utils.imageloader.CornerTransform;
import com.mobi.step.utils.imageloader.Utils;
import com.mobi.step.widget.AcceleratorCardDialog;
import com.mobi.step.widget.CustomDashboard;
import com.mobi.step.widget.GetGoldNewDialog;
import com.mobi.step.widget.GetRedDialog;
import com.mobi.step.widget.GoldDialog;
import com.mobi.step.widget.InterActionDialog;
import com.mobi.step.widget.LazyLoadFragment;
import com.mobi.step.widget.LoadWebViewActivity;
import com.mobi.step.widget.PlaqueDialog;
import com.mobi.step.widget.StepCeilingNewDialog;
import com.mobi.step.wxapi.WeixinHandler;
    ...
    private void initView() {
        ...
        adapter = new CommonAdapter<BannerBean.HotActivityList>(getContext(), R.layout.item_hotact_layout, hotActivityLists) {
            ...
            public void convert(RecycleViewHolder holder, final BannerBean.HotActivityList item) {
                ...
                com.mobi.step.utils.imageloader.ImageLoader.loadImage(getContext(), iv_bg, item.url);
...
//                                            }).build();
                            ...
                            if (demo.hot_activity_list != null && demo.hot_activity_list.size() > 0) {
                                if (demo.hot_activity_list.get(0) != null) {
                                    com.mobi.step.utils.imageloader.ImageLoader.loadImage(getContext(), image_two, demo.hot_activity_list.get(0).url);
                                ...
                                if (demo.hot_activity_list.get(1) != null) {
                                    com.mobi.step.utils.imageloader.ImageLoader.loadImage(getContext(), image_one, demo.hot_activity_list.get(1).url);
                            ...
                            if (demo.red_envelope != null) {
                                if (!TextUtils.isEmpty(demo.red_envelope.url) && !TextUtils.isEmpty(demo.red_envelope.jump_url)) {
                                    ...
                                    com.mobi.step.utils.imageloader.ImageLoader.loadImage(getContext(), iv_float, demo.red_envelope.url);
