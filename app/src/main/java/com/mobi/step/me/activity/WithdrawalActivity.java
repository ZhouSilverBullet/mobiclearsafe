...
import com.mobi.step.main.activity.FriendManagerActivity;
import com.mobi.step.main.activity.InviteActivity;
import com.mobi.step.me.bean.WithDrawalData;
import com.mobi.step.me.bean.WithDrawalItemBean;
...
import com.mobi.step.utils.DataUtils;
...
import com.mobi.step.widget.BindPhoneDialog;
import com.mobi.step.widget.BlockDialog;
import com.mobi.step.widget.GetRedDialog;
import com.mobi.step.widget.NoPaddingTextView;
import com.mobi.step.widget.TiXianSurpriseDialog;
import com.mobi.step.widget.WithdrawalDialog;
import com.mobi.step.widget.WithdrawalFailureDialog;
                                ...
                                WithdrawalFailureDialog dialog = new WithdrawalFailureDialog.Builder(WithdrawalActivity.this)
                                        ...
                                        .setListener(new WithdrawalFailureDialog.WithFailureListener() {
                                            ...
                                            public void inviteBtn(Dialog dialog) {
                                                dialog.dismiss();
                                                startActivity(new Intent(WithdrawalActivity.this,InviteActivity.class));
                                            }
                                        }).build();
                                dialog.show();
                            }
