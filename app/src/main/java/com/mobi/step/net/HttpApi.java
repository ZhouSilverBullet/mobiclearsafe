...
import com.mobi.step.fragment.bean.AggregationBean;
import com.mobi.step.fragment.bean.DialogCoinsBean;
import com.mobi.step.fragment.bean.SignBean;
import com.mobi.step.fragment.bean.SigninBean;
import com.mobi.step.fragment.bean.TargetStepBean;
import com.mobi.step.fragment.bean.TodayTaskBean;
import com.mobi.step.fragment.bean.TodayWelfareBean;
import com.mobi.step.fragment.bean.WelfareReceiveBean;
import com.mobi.step.main.BannerBean;
import com.mobi.step.main.BubbleClickBean;
import com.mobi.step.main.ConfigEntity;
import com.mobi.step.main.GoldBubble;
import com.mobi.step.main.PleasantlyBean;
import com.mobi.step.main.PleasantlyReceiveBean;
import com.mobi.step.main.RewardBean;
import com.mobi.step.main.StepExchangeCoins;
import com.mobi.step.main.UpdateBean;
import com.mobi.step.main.UserStepInfo;
import com.mobi.step.main.bean.CardState;
import com.mobi.step.main.bean.CollectNumBean;
import com.mobi.step.main.bean.EggBean;
import com.mobi.step.main.bean.ExitDialogBean;
import com.mobi.step.main.bean.ExperienceActivityBean;
import com.mobi.step.main.bean.HotNoticeBean;
import com.mobi.step.main.bean.IntegralBean;
import com.mobi.step.main.bean.IntegralWallReceiveBean;
import com.mobi.step.main.bean.InviteDetail;
import com.mobi.step.main.bean.InviteRecord;
import com.mobi.step.main.bean.NemberBean;
import com.mobi.step.main.bean.RedBean;
import com.mobi.step.main.bean.RedCoinsBean;
import com.mobi.step.main.bean.SignRaceSuccessBean;
import com.mobi.step.main.bean.StepRaceBean;
import com.mobi.step.main.bean.StepRaceHistoryBean;
import com.mobi.step.main.bean.StepRaceRewardBean;
import com.mobi.step.me.bean.MoneyRecordBean;
import com.mobi.step.me.bean.MyCardBean;
import com.mobi.step.me.bean.PointsBean;
import com.mobi.step.me.bean.PointsRecord;
import com.mobi.step.me.bean.ReceiveeErningsBean;
import com.mobi.step.me.bean.StepHistoryBean;
import com.mobi.step.me.bean.UploadNikeName;
import com.mobi.step.me.bean.WalletBean;
import com.mobi.step.me.bean.WithDrawalData;
import com.mobi.step.me.bean.WithdrawBean;
import com.mobi.step.me.bean.WithdrawCheckBean;
import com.mobi.step.moneyactivity.bean.ActivityBean;
import com.mobi.step.moneyactivity.bean.ActivityEntity;
import com.mobi.step.moneyactivity.bean.BindPhoneBean;
import com.mobi.step.moneyactivity.bean.CardBean;
import com.mobi.step.moneyactivity.bean.RewardEntity;
import com.mobi.step.moneyactivity.bean.SendSMSVerificationCode;
import com.mobi.step.moneyactivity.bean.ShareContentBean;
import com.mobi.step.moneyactivity.bean.SiginRemind;
import com.mobi.step.moneyactivity.bean.SigninDouble;
import com.mobi.step.moneyactivity.bean.TaskEntity;
import com.mobi.step.wxapi.bean.AccessTokenBean;
import com.mobi.step.wxapi.bean.LoginBean;
import com.mobi.step.wxapi.bean.UserInfo;
import com.mobi.step.wxapi.bean.WechatUserInfo;
...
public interface HttpApi {
     ...
     * @return
     */
    @GET("all-walking/v2/user/step/today/{user_id}")
     ...
     * @return
     */
    @GET("all-walking/v1/bubble-list/{user_id}")
     ...
     */
    @FormUrlEncoded
    @POST("all-walking/v2/invite/user")
